...
const useOpenChannelMessagesWithQuery = (sdk, channel, userId, options) => {
  ...
  (0, _useChannelHandler.useChannelHandler)(sdk, handlerId, {
    ...
    onMessageReceived(eventChannel, message) {
      ...
      if ((0, _uikitUtils.isMyMessage)(message, (_sdk$currentUser5 = sdk.currentUser) === null || _sdk$currentUser5 === void 0 ? void 0 : _sdk$currentUser5.userId)) return;
    ...
    onMessageUpdated(eventChannel, message) {
      ...
      if ((0, _uikitUtils.isDifferentChannel)(channel, eventChannel)) return;
      if ((0, _uikitUtils.isMyMessage)(message, (_sdk$currentUser8 = sdk.currentUser) === null || _sdk$currentUser8 === void 0 ? void 0 : _sdk$currentUser8.userId)) return;
