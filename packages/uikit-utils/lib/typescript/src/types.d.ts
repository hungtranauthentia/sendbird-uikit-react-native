...
import type { BaseChannel, Emoji, EmojiCategory, EmojiContainer, Encryption, Participant, RestrictedUser, SendbirdError as SBError, SendbirdChatWith, User, UserUpdateParams } from '@sendbird/chat';
...
import type { OpenChannelCreateParams, OpenChannelUpdateParams, SendableMessage } from '@sendbird/chat/lib/__definition';
import type { AdminMessage, BaseMessage, FileMessage, FileMessageCreateParams, FileMessageUpdateParams, MessageSearchQuery, MultipleFilesMessage, PreviousMessageListQuery, Reaction, UserMessage, UserMessageCreateParams, UserMessageUpdateParams } from '@sendbird/chat/message';
...
export type PartialDeep<T> = T extends object ? T extends Set<unknown> ? T : T extends Function ? T : {
