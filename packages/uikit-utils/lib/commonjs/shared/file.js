...
const audioExtRegex = /3gp|aac|aax|act|aiff|flac|gsm|m4a|m4b|m4p|tta|wma|mp3|webm|wav|ogg/i;
exports.audioExtRegex = audioExtRegex;
const videoExtRegex = /mov|vod|mp4|avi|mpeg|ogv/i;
exports.videoExtRegex = videoExtRegex;
const getFileType = extensionOrType => {
...
async function getFileExtensionFromUri(uri) {
