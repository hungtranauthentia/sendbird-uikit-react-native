import { getDateSeparatorFormat, getGroupChannelPreviewTime, getGroupChannelTitle, getMessagePreviewBody, getMessagePreviewTime, getMessagePreviewTitle, getMessageTimeFormat, getMessageType, getOpenChannelParticipants, getOpenChannelTitle, isVoiceMessage } from '@sendbird/uikit-utils';
  ...
  return {
    ...
    LABELS: {
      ...
      REPLY_FROM_SENDER_TO_RECEIVER: function (reply, parent) {
        let currentUserId = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : UNKNOWN_USER_ID;
