  ...
  return {
    ...
    GROUP_CHANNEL_LIST: {
      ...
      CHANNEL_PREVIEW_BODY: channel => {
        ...
        if ((0, _uikitUtils.isVoiceMessage)(channel.lastMessage)) return 'Voice message';
        return (0, _uikitUtils.getMessagePreviewBody)(channel.lastMessage);
      },
    ...
    MESSAGE_SEARCH: {
      ...
      SEARCH_RESULT_ITEM_BODY: message => {
        if ((0, _uikitUtils.isVoiceMessage)(message)) return 'Voice message';
        return (0, _uikitUtils.getMessagePreviewBody)(message);
      },
    ...
    LABELS: {
      ...
      REPLY_FROM_SENDER_TO_RECEIVER: function (reply, parent) {
        let currentUserId = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : _constants.UNKNOWN_USER_ID;
      ...
      CHANNEL_INPUT_REPLY_PREVIEW_BODY: message => {
        if (message.isFileMessage()) {
          const messageType = (0, _uikitUtils.getMessageType)(message);
          switch (messageType) {
            case 'file.image':
