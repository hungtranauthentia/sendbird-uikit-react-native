...
export const createMockMessageCollection = params => {
...
class MockMessageCollection {
  constructor(params) {
    ...
    _defineProperty(this, "filter", new MessageFilter());
    Object.assign(this, params);
    this.__messages = Array(this.params.dataLength ?? (this.params.limit ?? 10) * 5).fill(null).map(() => createMockMessage({
      sdk: this.params.sdk,
