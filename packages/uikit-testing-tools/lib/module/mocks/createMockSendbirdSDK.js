...
// @ts-nocheck
import { ChannelType, PushTriggerOption } from '@sendbird/chat';
...
export const createMockSendbirdChat = function () {
...
class MockSDK {
  ...
  constructor() {
    ...
    _defineProperty(this, "currentUser", createMockUser(this.__params));
    ...
    _defineProperty(this, "groupChannel", {
      ...
      createGroupChannelCollection: jest.fn(params => {
        this.__throwIfFailureTest();
        const gcc = createMockGroupChannelCollection({
          ...params,
          sdk: this.asMockSendbirdChatSDK()
        });
